...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/stekl0/Projects/laravel-city-elections/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/stekl0/Projects/laravel-city-elections/public/storage',
...
'pollingStation.index','pollingStation.store','pollingStation.create','pollingStation.show','pollingStation.edit',
'pollingStation.update','pollingStation.destroy','storage.local',);
        registerArgumentsSet('views', 
'hello','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui',
...
'polling_station','polling_station_create','polling_station_edit','polling_stations','region',
'regions','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.default','vendor.pagination.semantic-ui',
