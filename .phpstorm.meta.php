...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/maxdubmors/Projects/laravel-new-order-group/public/storage' => 'string',
...
'manage-polling-stations','manage-candidates','manage-regions','manage-polling-station-results',);
...
'filesystems.disks.s3.report','filesystems.links./home/maxdubmors/Projects/laravel-new-order-group/public/storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'web','api',);
        registerArgumentsSet('routes', 'home','navigation','login','auth',
'logout','region.index','region.show','pollingStation.index','pollingStation.create',
'pollingStation.store','pollingStation.show','pollingStation.edit','pollingStation.update','pollingStation.destroy',
'storage.local',);
        registerArgumentsSet('views', 
'errors.403','errors.404','footer','layout','login',
'navigation','notification','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default',
...
'pagination::tailwind','polling_station','polling_station_create','polling_station_edit','polling_stations',
'region','regions','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.default',
